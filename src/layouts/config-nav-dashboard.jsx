    ...
    items: [
      ...
      },
      {
        ...
        children: [
          ...
          { title: 'Create', path: paths.admin.product.new },
        ],
      },
      {
        title: 'Use Case',
        ...
        icon: ICONS.category,
        children: [
          { title: 'List', path: paths.admin.useCase.list },
          { title: 'Create', path: paths.admin.useCase.new },
        ],
      },
      {
        title: 'Size',
        path: paths.admin.size.root,
        icon: ICONS.category,
        children: [
          { title: 'List', path: paths.admin.size.list },
          { title: 'Create', path: paths.admin.size.new },
        ],
      },
      {
        title: 'Settings',
