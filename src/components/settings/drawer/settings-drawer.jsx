...
export function SettingsDrawer({
  ...
  const renderPresets = (
    <PresetsOptions
      ...
      options={[
        ...
        { name: 'brown', value: PRIMARY_COLOR.brown.main },
        { name: 'ai-nexus', value: PRIMARY_COLOR['ai-nexus'].main },
        { name: 'ai-nexus-yellow', value: PRIMARY_COLOR['ai-nexus-yellow'].main },
      ]}
    />
  );
  ...
  const renderFont = (
    <FontOptions
      ...
      options={[defaultFont, 'Inter', 'DM Sans', 'Nunito Sans', 'Montserrat', 'Pacifico']}
    />
  );
