...
export function fileFormat(fileUrl) {
  ...
  if (typeof fileUrl === 'string' && fileUrl.includes('res.cloudinary.com')) {
    // Cloudinary image URLs typically have '/image/upload/' in the path
    if (fileUrl.includes('/image/upload/')) {
      format = 'image';
      return format;
    }
    // Cloudinary video URLs have '/video/upload/' in the path
